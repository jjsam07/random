...
bool writeData(vm_address_t address, vm_address_t data, size_t size) {
...
//printf("info\n");
    ...
    err = vm_protect(port, address, size, NO, VM_PROT_READ | VM_PROT_WRITE | VM_PROT_COPY);
//printf("vm_protect\n");
